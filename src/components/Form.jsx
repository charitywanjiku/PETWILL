    ...
    <div className="border-b border-gray-900/10 pb-12">
      ...
      <div className="mt-10 grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div className="sm:col-span-3">
          ...
          <div className="mt-2">
            <input type="text" value={formData.firstName} name="firstName" id="firstName" onChange={handleChange} required className="block w-full bg-slate-200 rounded-md border-0 
        ...
        <div className="sm:col-span-3">
          ...
          <div className="mt-2">
            <input type="text" name="lastName" value={formData.lastName} id="lastName" onChange={handleChange} required className="block w-full bg-slate-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm  placeholder:text-gray-400  sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div className="sm:col-span-4">
          ...
          <div className="mt-2">
            <input id="email" name="email" type="email" value={formData.email} onChange={handleChange} required className="block w-full rounded-md bg-slate-200 border-0 py-1.5 text-gray-900 shadow-sm  placeholder:text-gray-400  sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div className="col-span-full">
          ...
          <div className="mt-2">
            <input type="text" name="address1" value={formData.address1} id="address1" onChange={handleChange} required className="block w-full rounded-md border-0 py-1.5 bg-slate-200 text-gray-900 shadow-sm  placeholder:text-gray-400  sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div className="col-span-full">
          ...
          <div className="mt-2">
            <input type="text" name="address2" value={formData.address2} id="address2" onChange={handleChange} required className="block w-full bg-slate-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm   placeholder:text-gray-400  sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div className="col-span-full">
          ...
          <div className="mt-2">
            <input type="text" name="position" value={formData.position} id="position" onChange={handleChange} required className="block w-full rounded-md bg-slate-200 border-0 py-1.5 text-gray-900 shadow-sm   placeholder:text-gray-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
